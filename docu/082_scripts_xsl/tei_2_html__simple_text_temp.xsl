<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" version="2.0" xmlns:egXML="http://www.tei-c.org/ns/Examples" exclude-result-prefixes="xsl tei egXML">
	...
	<xsl:template match="tei:ab[@type='caption']"><div class="abCaption"><xsl:value-of select="."/></div></xsl:template>
	...
	<xsl:template match="@*" mode="egXML">
		<span><xsl:text>
			</xsl:text><span class="spAttrName"><xsl:value-of select="local-name()"/></span><span class="spEquals">=</span><span class="spQuotes">"</span><span class="spValue"><xsl:value-of select="."/></span><span class="spQuotes">"</span></span>
	</xsl:template>
	...
	<xsl:template match="tei:head">
		<xsl:variable name="depth" select="count(ancestor::tei:div)"/>
		<xsl:variable name="visibility" select="parent::tei:div/@type"/>
		...
		<xsl:choose>
			<xsl:when test="$depth=1">
				...
				<table class="tbHead">
					<tr>
						<xsl:if test="not(@type='noNumbers')"><td class="tdHeadLeft1"></td></xsl:if>
						<td class="head1"><a class="aHeader" href="goto:{$sid}">
								<xsl:if test="not(@type='noNumbers')"><xsl:value-of select="$num1"/><xsl:text>
									</xsl:text></xsl:if>
								<xsl:apply-templates/></a>
							<xsl:if test="$visibility='invisible'"><span class="spInvisible"> (invisible)</span></xsl:if>
						</td></tr></table></xsl:when>
			<xsl:when test="$depth=2">
				<xsl:variable name="num1"><xsl:value-of select="count(parent::tei:div/parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<xsl:variable name="num2"><xsl:value-of select="count(parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<table class="tbHead"><tr><td class="tdHeadLeft2"></td><td class="head2"><a class="aHeader" href="goto:{$sid}"><xsl:value-of select="concat($num1, '.', $num2)"/>
								<xsl:text>
								</xsl:text>
								<xsl:apply-templates/></a>
							<xsl:if test="$visibility='invisible'"><span class="spInvisible"> (invisible)</span></xsl:if></td></tr></table>
			</xsl:when>
			<xsl:when test="$depth=3">
				<xsl:variable name="num1"><xsl:value-of select="count(parent::tei:div/parent::tei:div/parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<xsl:variable name="num2"><xsl:value-of select="count(parent::tei:div/parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<xsl:variable name="num3"><xsl:value-of select="count(parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<table class="tbHead"><tr><td class="tdHeadLeft3"></td><td class="head3"><a class="aHeader" href="goto:{$sid}"><xsl:value-of select="concat($num1, '.', $num2, '.', $num3)"/>
								<xsl:text>
								</xsl:text>
								<xsl:apply-templates/></a>
							<xsl:if test="$visibility='invisible'"><span class="spInvisible"> (invisible)</span></xsl:if>
			...
			<xsl:when test="$depth=4">
				...
				<xsl:variable name="num3"><xsl:value-of select="count(parent::tei:div/parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<xsl:variable name="num4"><xsl:value-of select="count(parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<table class="tbHead"><tr><td class="tdHeadLeft4"></td><td class="head4"><a class="aHeader" href="goto:{$sid}">
								<xsl:value-of select="concat($num1, '.', $num2, '.', $num3, '.', $num4)"/>
								<xsl:text>
								</xsl:text>
								<xsl:apply-templates/></a>
			...
			<xsl:when test="$depth=5">
				...
				<xsl:variable name="num4"><xsl:value-of select="count(parent::tei:div/parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<xsl:variable name="num5"><xsl:value-of select="count(parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<table class="tbHead"><tr><td class="tdHeadLeft5"></td><td class="head5"><a class="aHeader" href="goto:{$sid}">
								<xsl:value-of select="concat($num1, '.', $num2, '.', $num3, '.', $num4, '.', $num5)"/>
								<xsl:text>
								</xsl:text>
								<xsl:apply-templates/></a>
			...
			<xsl:when test="$depth=6">
				...
				<xsl:variable name="num5"><xsl:value-of select="count(parent::tei:div/parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<xsl:variable name="num6"><xsl:value-of select="count(parent::tei:div/preceding-sibling::tei:div)+1"/></xsl:variable>
				<table class="tbHead"><tr><td class="tdHeadLeft6"></td><td class="head6"><a class="aHeader" href="goto:{$sid}">
								<xsl:value-of select="concat($num1, '.', $num2, '.', $num3, '.', $num4, '.', $num5, '.', $num6)"/>
								<xsl:text>
								</xsl:text>
								<xsl:apply-templates/></a>
	...
	<xsl:template match="tei:name[@type='application']">
		<span class="applicationName"><xsl:value-of select="."/></span>
	</xsl:template>
	<xsl:template match="tei:name[@type='appPart']">
		<span class="appPart"><xsl:value-of select="."/></span>
	</xsl:template>
