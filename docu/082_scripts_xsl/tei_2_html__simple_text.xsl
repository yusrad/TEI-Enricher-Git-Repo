   ...
   <xsl:template match="/">
      <html>
         ...
         <head>
            ...
            <link rel="stylesheet" href="../650_css/docu__001.css"></link>
         </head>
      ...
      <xsl:choose>
            ...
            <table class="tbHead">
              <tr>
                ...
                <td class="head1"><a class="aHeader" href="goto:{$sid}">
                   <xsl:if test="not(@type='noNumbers')"><xsl:value-of select="$num1"/><xsl:text> </xsl:text></xsl:if>
         ...
         <xsl:when test="$depth=2">
            ...
            <table class="tbHead"><tr><td class="tdHeadLeft2"></td><td class="head2"><a class="aHeader" href="goto:{$sid}"><xsl:value-of select="concat($num1, '.', $num2)"/>
                  <xsl:text> </xsl:text> <xsl:apply-templates/></a>
